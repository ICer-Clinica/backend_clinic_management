...
var CreatePatientService = /** @class */ (function () {
    ...
    CreatePatientService.prototype.execute = function (_a) {
        var name = _a.name, sus_card = _a.sus_card, phone = _a.phone, cpf = _a.cpf, birth_date = _a.birth_date, clinic_id = _a.clinic_id;
        return __awaiter(this, void 0, void 0, function () {
            var repo, clinicRepo, procedureExists, clinicExists, patient;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, repo.save(patient)];
                    case 3:
                        _b.sent();
