...
var CreateSuperadminService = /** @class */ (function () {
    function CreateSuperadminService() {
    }
    CreateSuperadminService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, password = _a.password, role = _a.role;
        return __awaiter(this, void 0, void 0, function () {
            var repo, superadminExists, superadmin;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        superadminExists = _b.sent();
                        if (superadminExists) {
                            return [2 /*return*/, new Error('Superadmin already exists!')];
                        }
                        superadmin = repo.create({
                            name: name,
                            email: email,
                            password: password,
                            role: role,
                        });
                        return [4 /*yield*/, repo.save(superadmin)];
                    case 2:
                        _b.sent();
