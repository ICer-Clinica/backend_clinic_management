...
var CreateAddressService = /** @class */ (function () {
    ...
    CreateAddressService.prototype.execute = function (_a) {
        var street = _a.street, number = _a.number, district = _a.district;
        return __awaiter(this, void 0, void 0, function () {
            var repo, addressExists, address;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repo = (0, typeorm_1.getRepository)(AddressEntitie_1.Address);
                        return [4 /*yield*/, repo.findOne({ where: { street: street } })];
                    case 1:
                        addressExists = _b.sent();
                        if ((addressExists === null || addressExists === void 0 ? void 0 : addressExists.street) === street &&
                            ...
                            return [2 /*return*/, new Error('Address already exists!')];
                        }
                        address = repo.create({
                            street: street,
                            number: number,
